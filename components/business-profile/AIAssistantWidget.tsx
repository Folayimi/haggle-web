      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <p className="text-xs text-muted/60 mb-4">Smart suggestions to grow your business</p>
              ...
              <div className="space-y-3">
                {suggestions.map((s) => (
                  <div key={s.id} className="rounded-xl border border-border/30 bg-background-elevated/20 p-3">
                    ...
                    {s.action && (
                      <button onClick={s.action} className="mt-2 text-xs text-primary hover:text-primary-strong flex items-center gap-1">
